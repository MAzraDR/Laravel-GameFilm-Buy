...
class PeminjamanController extends Controller
{
    ...
    public function store(Request $request) {
        $payload = $request->only("email", "film_id", "borrowed_at", "due_date", "status");
    ...
    public function update(Request $request, $id) {
        ...
        $request->validate([
            ...
            'film_id' => 'integer', // Ganti 'string' menjadi 'integer' jika film_id seharusnya berupa integer
        ...
        $peminjaman->update([
            ...
            'film_id' => $request->input('film_id', $peminjaman->film_id),
